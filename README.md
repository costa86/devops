...
### About the files in ``/.ssd`` folder
 ...
 #### known_hosts
"Remembers" the machines you have previously connected to. Every time you connect to a new machine, its fingerprint will be saved here (and you will be notified of that). It is a mechanism to verify that  the machine you are connecting to is actually the one you think it is.
...
In this project you will scripts to automate some tasks related to the concepts explained above
